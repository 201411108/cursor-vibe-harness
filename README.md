...
[![npm version](https://img.shields.io/npm/v/cursor-agent-harness.svg)](https://www.npmjs.com/package/cursor-agent-harness)
...
npx cursor-agent-harness install
```
...
```bash
npx cursor-agent-harness install --global
```
...
```bash
npm install -g cursor-agent-harness
cursor-agent-harness install             # 프로젝트 설치
cursor-agent-harness install --global    # 전역 설치
```

### git clone

```bash
git clone https://github.com/handong/cursor-agent-harness.git
...
```bash
npx cursor-agent-harness install --force
npx cursor-agent-harness install --global --force
```

### 설치 상태 확인

```bash
npx cursor-agent-harness list
```
...
```bash
npx cursor-agent-harness uninstall            # 프로젝트에서 제거
npx cursor-agent-harness uninstall --global   # 전역에서 제거
```

...
[![npm version](https://img.shields.io/npm/v/%40hankim%2Fcursor-vibe-harness.svg)](https://www.npmjs.com/package/@hankim/cursor-vibe-harness)
...
npx @hankim/cursor-vibe-harness install
```
...
```bash
npx @hankim/cursor-vibe-harness install --global
```
...
```bash
npm install -g @hankim/cursor-vibe-harness
...
```bash
npx @hankim/cursor-vibe-harness install --force
npx @hankim/cursor-vibe-harness install --global --force
```

### 설치 상태 확인

```bash
npx @hankim/cursor-vibe-harness list
```
...
```bash
npx @hankim/cursor-vibe-harness uninstall            # 프로젝트에서 제거
npx @hankim/cursor-vibe-harness uninstall --global   # 전역에서 제거
```
...
```bash
cd /path/to/your-project
npx @hankim/cursor-vibe-harness init
```
